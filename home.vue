        		...
        		<div class="site_container">
        		    <div class="visible_phone">
        		        <div class="homepage_hours">
        		            <h5 class="home_page_subtitle center caps" v-if="hour.is_open" v-for="hour in todaysHours">Open Now:</h5>
                            ...
                            <h5 class="home_page_subtitle center caps" v-if="!hour.is_open" v-for="hour in todaysHours"></h5>
                            <h3 class="home_page_title caps" v-if="!hour.is_open">Closed</h3>
                        </div>
