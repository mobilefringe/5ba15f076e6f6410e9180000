...
<script>
    define(["Vue", "vuex", "vue!vue-slick", "js-cookie", "masonry", "vue-masonry-plugin", "vue!mapplic-map"], function(Vue, Vuex, slick, Cookies, masonry, VueMasonryPlugin, MapplicComponent) {
